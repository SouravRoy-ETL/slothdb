-- ClickBench queries (43 total) verbatim from ClickHouse/ClickBench
-- repository, _data/queries.sql, DuckDB variant. Reproduced under the
-- Apache 2.0 license. See bench/clickbench/README.md for setup.
